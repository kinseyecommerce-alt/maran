...
- [Live Price Data Pipeline](live-price-pipeline.md) — TrueData WS → Kite WS (auto-fallback) → REST polling. Yahoo Finance fully removed. subscribe() now triggers backfill for newly added symbols.

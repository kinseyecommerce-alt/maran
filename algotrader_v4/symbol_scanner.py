...
NIFTY_50 = [
    ...
    "TITAN","POWERGRID","NTPC","TECHM","BAJAJFINSV","ONGC","TATASTEEL",
    "TMPV","DRREDDY","SUNPHARMA","CIPLA","DIVISLAB","GRASIM",
    "JSWSTEEL","INDUSINDBK","HDFCLIFE","SBILIFE","BPCL","EICHERMOT",
    "HEROMOTOCO","COALINDIA","BRITANNIA","APOLLOHOSP","TRENT","SHRIRAMFIN",
    "BAJAJ-AUTO","M&M","HINDALCO","TMCV","ADANIENT",
]
...
class SymbolScanner:
    ...
    def _score_symbol(self, symbol: str) -> Optional[SymbolScore]:
        ...
        try:
            ...
            if (math.isfinite(sc.ema9) and math.isfinite(sc.ema21)):

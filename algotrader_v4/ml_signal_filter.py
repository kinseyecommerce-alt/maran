...
class MLSignalFilter:
    ...
    def _warm_from_history(self) -> None:
        """
        Called once during __init__ if no saved model was found.
        If >= 30 historical trades exist, kicks off a background retrain
        so the model is ready as soon as possible after startup.
        """
        try:
